...
Процедура ВыгрузитьДанныеНаСервере()
	...
	ВыгрузитьРегистрИстория_7_49(ЗаписьXML);
...
&НаСервере
Процедура ВыгрузитьРегистрИстория_7_49(ЗаписьXML)
	
	Запрос = Новый Запрос;
	Запрос.Текст = 
		"ВЫБРАТЬ
		|	История_7_49.НомерТиража КАК НомерТиража,
		|	История_7_49.Число1 КАК Число1,
		|	История_7_49.Число2 КАК Число2,
		|	История_7_49.Число3 КАК Число3,
		|	История_7_49.Число4 КАК Число4,
		|	История_7_49.Число5 КАК Число5,
		|	История_7_49.Число6 КАК Число6,
		|	История_7_49.Число7 КАК Число7,
		|	История_7_49.СуммаВыйгрыша КАК СуммаВыйгрыша
		|ИЗ
		|	РегистрСведений.История_7_49 КАК История_7_49";
	...
	Пока ВыборкаЗапись.Следующий() Цикл
		...
		НаборЗаписей = РегистрыСведений.История_7_49.СоздатьНаборЗаписей();
